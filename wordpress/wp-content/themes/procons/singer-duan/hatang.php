...
<style>
    .bg-banner-hatang {
        background-image: url(https://procons.com.vn/wp-content/uploads/2022/10/banner4-scaled.jpg);
...
<div class="banner">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 bg-banner-hatang">
                <div class="overlay"></div>
                <div class="title-banner">
                    <h1>HẠ TẦNG</h1>
                    <p><a href="http://localhost/wordpress/">Home</a> >> Dự Án >> Hạ Tầng</p>
                </div>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-12 box-item-duan">
            <p>Không có dự án nào thuộc danh mục, vui lòng quay lại trang chủ !</p>
        </div>
    </div>
</div>
