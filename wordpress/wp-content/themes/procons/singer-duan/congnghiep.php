...
/**
 * Template name: cong nghiep
 */

get_header();
?>
<style>
    .bg-banner-congnghiep {
        background-image: url(https://procons.com.vn/wp-content/uploads/2022/10/banner3-scaled.jpg);
...
<div class="banner">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 bg-banner-congnghiep">
                <div class="overlay"></div>
                <div class="title-banner">
                    <h1>CÔNG NGHIỆP</h1>
                    <p><a href="http://localhost/wordpress/">Home</a> >> Dự Án >> Công Nghiệp</p>
                </div>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-12 box-item-duan">
            <div class="row">
                <div class="col-4">
                    <img src="https://procons.com.vn/wp-content/uploads/2022/10/nhakho1.jpg" alt="">
                </div>

                <div class="col-8">
                    <div class="box-title-link">
                        <a class="title-link" href="">THIẾT KẾ NHÀ KHO CHỨA VỎ CHAI – SABECO MIỀN ĐÔNG</a>

                    </div>
                    <p>
                        Quy mô: Diện tích xây dựng 1100m2 <br>
                        Vị trí: Tây Ninh.
                    </p>
